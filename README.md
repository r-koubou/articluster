...
- <a id="definitions/MidiMessage"></a>**`MidiMessage`** *(object)*: A MIDI message within the articulation, consisting of a status byte and two data bytes. Cannot contain additional properties.
  - <a id="definitions/MidiMessage/properties/Status"></a>**`Status`** *(integer, required)*: MIDI Status Byte.
  - <a id="definitions/MidiMessage/properties/Channel"></a>**`Channel`** *(integer)*: MIDI Channel (0-15). If `-1` or `not defined`, it will be ignored in conversion.
  - <a id="definitions/MidiMessage/properties/Data1"></a>**`Data1`** *(integer)*: MIDI Data Byte 1 (0-127). If `not defined`, it will be ignored in conversion.
  - <a id="definitions/MidiMessage/properties/Data2"></a>**`Data2`** *(integer)*: MIDI Data Byte 2 (0-127). If `not defined`, it will be ignored in conversion.
