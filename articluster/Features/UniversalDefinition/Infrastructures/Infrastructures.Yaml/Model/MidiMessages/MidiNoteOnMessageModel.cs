...
{
    public sealed class MidiNoteOnMessageModel : IMidiChannelVoiceMessageModel
    {
        [YamlIgnore]
        public int Status
            => 0x90 | ( Channel & 0xF );
        ...
        public MidiNoteOnMessageModel() {}

        public MidiNoteOnMessageModel( int channel, int noteNumber, int velocity )
        {
            Channel = channel;
            Data1   = noteNumber;
            Data2   = velocity;
